# Frontend TODO (for Chris) — CLOSED OUT

**All items below are done and verified as of 2026-07-12.** Chris's
...
what was done rather than deleted.
...
Chris's `chris/part-c-gallery-newsletter-api` branch + Rob's end-to-end verification — all items
done._
